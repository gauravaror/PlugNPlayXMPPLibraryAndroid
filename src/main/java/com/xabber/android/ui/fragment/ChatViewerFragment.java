...
public class ChatViewerFragment extends Fragment implements PopupMenu.OnMenuItemClickListener,
    ...
    public boolean onMenuItemClick(MenuItem item) {
        ...
        if (i == R.id.action_start_encryption) {
            ...
            return true;
        } else if (i == R.id.action_leave_conference) {
            leaveConference(account, user);
            return true;
        } else if (i == R.id.action_list_of_occupants) {
            startActivity(OccupantList.createIntent(getActivity(), account, user));
            return true;

            /* message popup menu */
        } else if (i == R.id.action_message_repeat) {
