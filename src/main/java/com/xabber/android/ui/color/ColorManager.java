...
public class ColorManager {
    ...
    private int getThemeResource(Context context, int themeResourceId) {
        ...
        final int accountGroupColorsResourceId = a.getResourceId(0, R.array.account_50);
        a.recycle();
    ...
    public int getThemeColor(Context context, int attr) {
        ...
        final int color = a.getColor(0, context.getResources().getColor(R.color.amber_400));
        a.recycle();
        return color;
    }
