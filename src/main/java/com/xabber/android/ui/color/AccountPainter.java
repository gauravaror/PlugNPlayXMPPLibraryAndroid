...
public class AccountPainter {
    ...
    AccountPainter(Context context) {
        ...
        accountColorNames = context.getResources().getStringArray( com.xabber.android.R.array.account_color_names);

        themeMainColor = getThemeMainColor(context);
        themeDarkColor = getThemeDarkColor(context);
        themeTextColor = getThemeTextColor(context);

        greyMain = context.getResources().getColor( com.xabber.android.R.color.grey_600);
        greyDark = context.getResources().getColor( com.xabber.android.R.color.grey_700);
    }
    ...
    private int getThemeMainColor(Context context) {
        return context.getResources().getColor(getThemeAttribute(context, com.xabber.android.R.attr.colorPrimary));
    }

    private int getThemeDarkColor(Context context) {
        return context.getResources().getColor(getThemeAttribute(context, com.xabber.android.R.attr.colorPrimaryDark));
    }
