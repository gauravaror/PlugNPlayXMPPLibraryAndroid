...
public class AccountManager implements OnLoadListener, OnWipeListener {
    ...
    public String addAccount(String user, String password, AccountType accountType, boolean syncable,
                             boolean storePassword, boolean useOrbot, boolean registerNewAccount) throws NetworkException {
        return addAccount(user,password, accountType, syncable, storePassword, useOrbot, registerNewAccount, 5);
    }
    /**
     * Creates new account.
     *
     ...
     */
    public String addAccount(String user, String password, AccountType accountType, boolean syncable,
                             boolean storePassword, boolean useOrbot, boolean registerNewAccount, int colorIndex)
        ...
        accountItem = addAccount(accountType.getProtocol(), useCustomHost, host, port, serverName, userName,
                storePassword, password, resource, getNextColorIndex(), colorIndex, StatusMode.available,
    ...
    public void setColorIndex(String account, int color) {
        AccountItem accountItem = AccountManager.getInstance().getAccount(account);
        ConnectionSettings connectionSettings = accountItem.getConnectionSettings();
        AccountManager.getInstance().updateAccount(
                account,
