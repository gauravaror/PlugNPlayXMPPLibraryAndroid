...
public class SettingsManager implements OnInitializedListener,
    ...
    public static void setEventsMessage(EventsMessage value) {
        if (value == EventsMessage.chat) {
            setString(R.string.events_message_key, Application.getInstance()
                    .getString(R.string.events_message_chat_and_muc_value));
        } else  if (value == EventsMessage.chatAndMuc){
            setString(R.string.events_message_key, Application.getInstance()
                    .getString(R.string.events_message_chat_and_muc_value));
        } else if (value == EventsMessage.none){
            setString(R.string.events_message_key, Application.getInstance()
                    .getString(R.string.events_message_none_value));
        } else {
            throw  new IllegalStateException();
        }
